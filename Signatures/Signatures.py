...
class ElGamalSignature:
    ...
    def sign(self, message: bytes) -> Tuple[int, int]:
        ...
        while True:
            # Choix de k aléatoire avec gcd(k, p-1) = 1
...
def demonstrate_malleability():
    ...
    # Attaque par malléabilité - Leçon théorique
